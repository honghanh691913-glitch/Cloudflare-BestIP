...
function renderSettings(){
  ...
  <div class="settings-card"><h3>真连接 / 真测速</h3><div class="modal-note"><b>${buildInfo.real_test_ready?'sing-box 核心已就绪':'当前镜像没有 sing-box 核心'}</b>。真连接会完整走 VLESS → TLS/ECH → WebSocket → 测试网址。整批候选共用一个 sing-box，并先热身 DNS/ECH；冷启动耗时不计入真延迟，只替换候选 IP，不改节点其他参数。</div>
